...
//done you are given movie list
//done first page of application should be movie gallery with movie cards
//done each cart should have: title, year, rating, comments length, and cover image
